...
public record VersionInfo(ArtifactMetadata assetIndex, String assets, Downloads downloads, String id,
	...
	public VersionInfo withUpdatedId(String versionId) {
		...
		return new VersionInfo(this.assetIndex(), this.assets(), this.downloads(), versionId, this.javaVersion(), this.libraries(), this.mainClass(), this.releaseTime(), this.time(), this.type(), this.arguments());
	}
