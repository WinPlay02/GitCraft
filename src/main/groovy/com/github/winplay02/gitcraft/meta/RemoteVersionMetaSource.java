...
public class RemoteVersionMetaSource<M extends VersionMeta<M>> implements VersionMetaSource<M> {
	...
	public M getLatest(String clas) throws IOException {
		if (latestVersions == null) {
			List<M> allVersions = SerializationHelper.deserialize(SerializationHelper.fetchAllFromURL(new URL(url)), metaType);
